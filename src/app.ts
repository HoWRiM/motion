import { Composable, PageComponent, PageItemCompoenet } from "./components/page/page.js";
...
class App {
	...
	constructor(appRoot: HTMLElement, private dialogRoot: HTMLElement) {
		this.page = new PageComponent(PageItemCompoenet);
		this.page.attachTo(appRoot);

		// http://picsum.photos/600/300
		// https://www.youtube.com/watch?v=0xJxgvJO2Xo
